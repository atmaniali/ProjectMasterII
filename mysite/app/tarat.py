...
weight = "/home/ali/Documents/MasterIIproect/weight.csv"
...
#     weights = np.loadtxt(MPfiles,dtype = 'float', skiprows=0, delimiter=',')
...
weights =list(csv.reader(open(weight, "r"), delimiter=","))  
print('weights \n', weights) 
array_weights = np.asarray(weights[0], dtype='float')
print('array_weights \n', array_weights)
weights1 = np.loadtxt(weight, delimiter=',', dtype=float)
array_weights1 = np.asarray(weights1[0], dtype='float')
print('weights1 \n', weights1)
print('array_weights1 \n', array_weights1)
