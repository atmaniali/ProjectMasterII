...
# creter:
# CarachterisiqueVaccin, Posologie, Cout, EffetsSecondaire
# ****
# subcriter:
# **
# I / Carachterisique Vaccin:
# Type, Efficacite
# I.I / 
# Efficacite
# **
# II / Posologie:
# NBrDose, Age, Delais(jours), Temps_d_effet(M)
# **
# III / Cout:
# Conservation, Prix(euro)
# **
# IV / Effets Secondaire:
# **
# sensibilité au point d'injection, douleur au point d'injection, céphalées, hyperthermie, nausées, fatigue
# ***
# alternative
# //                                                                                                                           //
